...
echo "   ${CYAN}Terminal 4 - Fila SQS (vai acumular centenas de mensagens) Fila SQS:${NC}"
   echo "   Terminal 4 - Fila SQS:"
   echo "   watch -n 5 'aws sqs get-queue-attributes --queue-url https://sqs.us-east-1.amazonaws.com/794038226274/keda-demo-queue.fifo --attribute-names ApproximateNumberOfMessages'"
